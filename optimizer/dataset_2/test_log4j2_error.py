...
df = pd.read_csv("laaber_preprocessed_fse20/laaber_log4j2.csv", index_col="m_id")
...
broken_df.to_csv("laaber_preprocessed_fse20/laaber_log4j2_list_of_broken_benchmarks.csv", index=False)
